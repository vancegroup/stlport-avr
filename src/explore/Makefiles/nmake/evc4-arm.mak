...
DEFS_COMMON = /D _WIN32_WCE=$(CEVERSION) /D "$(PLATFORM)" /D UNDER_CE=$(CEVERSION) /D "UNICODE" /D "ARM" /D "_ARM_" /D "ARMV4"
...
OPT_DBG = $(OPT_DBG) /Zi /Od
OPT_STLDBG = $(OPT_STLDBG) /Zi /Od
OPT_STATIC_REL = $(OPT_STATIC_REL) /O2 /Og
OPT_STATIC_DBG = $(OPT_STATIC_DBG) /Zi /Od
OPT_STATIC_STLDBG = $(OPT_STATIC_STLDBG) /Zi /Od
