...
$(SO_NAME_OUT):	$(OBJ) $(RES) $(LIBSDEP)
	...
	@if exist $(MANIFEST_NAME_OUT) mt /manifest $(MANIFEST_NAME_OUT) /outputresource:$(SO_NAME_OUT);#2

$(SO_NAME_OUT_DBG):	$(OBJ_DBG) $(RES_DBG) $(LIBSDEP)
	$(LINK_cc_DBG) $(LINK_OUTPUT_OPTION) $(OBJ_DBG) $(RES_DBG) $(LDLIBS)
	@if exist $(MANIFEST_NAME_OUT_DBG) mt /manifest $(MANIFEST_NAME_OUT_DBG) /outputresource:$(SO_NAME_OUT_DBG);#2

$(SO_NAME_OUT_STLDBG):	$(OBJ_STLDBG) $(RES_STLDBG) $(LIBSDEP)
	$(LINK_cc_STLDBG) $(LINK_OUTPUT_OPTION) $(OBJ_STLDBG) $(RES_STLDBG) $(LDLIBS)
	@if exist $(MANIFEST_NAME_OUT_STLDBG) mt /manifest $(MANIFEST_NAME_OUT_STLDBG) /outputresource:$(SO_NAME_OUT_STLDBG);#2
