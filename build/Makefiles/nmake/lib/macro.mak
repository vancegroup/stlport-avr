...
LIB_NAME_SUFFIX = _x_$(STLP_BUILD_LIB_MOTIF).$(MAJOR).$(MINOR)
!else
LIB_NAME_SUFFIX = _$(STLP_BUILD_LIB_MOTIF).$(MAJOR).$(MINOR)
!endif
!else
!ifdef STLP_BUILD_FORCE_STATIC_RUNTIME
LIB_NAME_SUFFIX = _x.$(MAJOR).$(MINOR)
!else
...
SO_NAME_BASE    = $(LIB_NAME_PREFIX)$(LIBNAME)$(LIB_NAME_SUFFIX)
...
SO_NAME_DBG_BASE = $(LIB_NAME_PREFIX)$(LIBNAME)$(DBG_SUFFIX)$(LIB_NAME_SUFFIX)
...
SO_NAME_STLDBG_BASE = $(LIB_NAME_PREFIX)$(LIBNAME)$(STLDBG_SUFFIX)$(LIB_NAME_SUFFIX)
...
A_NAME_BASE = $(LIB_NAME_PREFIX)$(LIBNAME)$(LIB_TYPE)$(LIB_NAME_SUFFIX)
A_NAME = $(A_NAME_BASE).$(ARCH)
A_NAME_OUT = $(OUTPUT_DIR_A)\$(A_NAME)
A_PDB_NAME = $(A_NAME_BASE).pdb
A_PDB_NAME_OUT = $(OUTPUT_DIR_A)\$(A_PDB_NAME)

A_NAME_DBG_BASE = $(LIB_NAME_PREFIX)$(LIBNAME)$(DBG_SUFFIX)$(LIB_TYPE)$(LIB_NAME_SUFFIX)
...
A_NAME_STLDBG_BASE = $(LIB_NAME_PREFIX)$(LIBNAME)$(STLDBG_SUFFIX)$(LIB_TYPE)$(LIB_NAME_SUFFIX)
