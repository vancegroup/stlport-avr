...
${SO_NAME_OUT}:	$(OBJ) $(RES) $(LIBSDEP) $(LSUPC++DEF)
	$(LINK.cc) $(LINK_OUTPUT_OPTION) $(OBJ) $(LSUPC++DEF) $(RES) $(LDLIBS) $(STDLIBS)
${SO_NAME_OUT_DBG}:	$(OBJ_DBG) $(RES_DBG) $(LIBSDEP) $(LSUPC++DEF)
	$(LINK.cc) $(LINK_OUTPUT_OPTION) $(OBJ_DBG) $(LSUPC++DEF) $(RES_DBG) $(LDLIBS) $(STDLIBS)
${SO_NAME_OUT_STLDBG}:	$(OBJ_STLDBG) $(RES_STLDBG) $(LIBSDEP) $(LSUPC++DEF)
	$(LINK.cc) $(LINK_OUTPUT_OPTION) $(OBJ_STLDBG) $(LSUPC++DEF) $(RES_STLDBG) $(LDLIBS) $(STDLIBS)
endif
endif
