// -*- C++ -*- Time-stamp: <2010-12-13 21:05:57 ptr>
...
int EXAM_IMPL(type_traits_test::type_traits_is_union)
{
  ...
  EXAM_CHECK( std::tr1::is_union<int>::value == false );
...
int EXAM_IMPL(type_traits_test::type_traits_is_class)
{
  ...
  EXAM_CHECK( std::tr1::is_class<int>::value == false );
...
int EXAM_IMPL(type_traits_test::type_traits_is_volatile)
{
  ...
  EXAM_CHECK( std::tr1::is_volatile<const volatile int&>::value == false );
  EXAM_CHECK( std::tr1::is_volatile<volatile int&>::value == false );
#ifdef _STLP_RVR
  EXAM_CHECK( std::tr1::is_volatile<volatile int&&>::value == false );
#endif
...
int EXAM_IMPL(type_traits_test::is_constructible)
{
  ...
  typedef std::tr1::is_constructible<MyTo,MyFrom> T1;
  typedef std::tr1::is_constructible<MyTo,MyOther> T2;
  typedef std::tr1::is_constructible<MyTo,int> T3;
  typedef std::tr1::is_constructible<MyOther,int> T4;
  typedef std::tr1::is_constructible<int,double> T5;
...
int EXAM_IMPL(type_traits_test::is_assignable)
{
  ...
  typedef std::tr1::is_assignable<int,double> T1;
  typedef std::tr1::is_assignable<double,int> T2;
  typedef std::tr1::is_assignable<MyOne,int> T3;
  typedef std::tr1::is_assignable<MyTwo,int> T4;
  typedef std::tr1::is_assignable<int,MyOne> T5;
  typedef std::tr1::is_assignable<int,MyTwo> T6;
...
int EXAM_IMPL(type_traits_test::is_destructible)
{
  ...
  typedef std::tr1::is_destructible<My> T1;
  typedef std::tr1::is_destructible<Other> T2;
  typedef std::tr1::is_destructible<YetAnother> T3;
  typedef std::tr1::is_destructible<int> T4;
...
int EXAM_IMPL(type_traits_test::is_trivially_copyable)
{
  ...
  typedef std::tr1::is_trivially_copyable<Base> T1;
  typedef std::tr1::is_trivially_copyable<Derive> T2;
  typedef std::tr1::is_trivially_copyable<DeriveA> T3;
