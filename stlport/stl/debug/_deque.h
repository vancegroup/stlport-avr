...
inline _Tp* value_type(const  _DBG_iter_base< __STL_DEQUE_SUPER >&) {
  return (_Tp*)0;
}
template <class _Tp, class _Alloc>
inline random_access_iterator_tag iterator_category(const  _DBG_iter_base< __STL_DEQUE_SUPER >&) {
