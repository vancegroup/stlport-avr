...
__STL_EXPORT_TEMPLATE_CLASS _Rb_global<bool>;
# endif
...
protected:
  ...
  _Link_type _M_create_node(const value_type& __x)
  {
    ...
    __STL_UNWIND(this->_M_header.deallocate(__tmp,1));
    return __tmp;
  }
...
public:    
  ...
  void swap(_Rb_tree<_Key,_Value,_KeyOfValue,_Compare,_Alloc>& __t) {
    __STLPORT_STD::swap(this->_M_header._M_data, __t._M_header._M_data);
