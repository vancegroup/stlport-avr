...
template <class __number> \
  const __type _Numeric_limits_base<__number>:: __mem __STL_OUTLINE_STATIC_INIT(_Init)
...
template <class _Int, __STL_LIMITS_MIN_TYPE __imin, __STL_LIMITS_MAX_TYPE __imax, int __idigits, bool __ismod> \
  const __type _Integer_limits<_Int, __imin, __imax, __idigits, __ismod>:: __mem __STL_OUTLINE_STATIC_INIT(_Init)
...
const __type _Floating_limits< __number, __Digits, __Digits10,    \
         ...
         __mem __STL_OUTLINE_STATIC_INIT(_Init)
...
__declare_int_members(__STL_LONG_LONG, LONGLONG_MIN, LONG_MAX, -1)
__declare_int_members(unsigned __STL_LONG_LONG, 0, ULONGLONG_MAX, -1)
#  endif
...
# ifdef __STL_EXPOSE_GLOBALS_IMPLEMENTATION
...
# elif defined (__STL_LITTLE_ENDIAN)

# define __STL_FLOAT_INF_REP { 0, 0x7f80 }
# define __STL_FLOAT_QNAN_REP { 0, 0xffc0 }
# define __STL_FLOAT_SNAN_REP { 0, 0xff80 }
# define __STL_DOUBLE_INF_REP { 0, 0, 0, 0x7ff0 }
# define __STL_DOUBLE_QNAN_REP { 0, 0, 0, 0xfff8 }
# define __STL_DOUBLE_SNAN_REP { 0, 0, 0, 0xfff0 }
// note : this is IA-32 80-bit address. WOn't work for any other little-endian
// machines !
# define __STL_LDOUBLE_INF_REP { 0, 0, 0, 0x7fff, 0x8000 } // ????
# define __STL_LDOUBLE_QNAN_REP { 0, 0, 0, 0xffff, 0xc000 } // ????
# define __STL_LDOUBLE_SNAN_REP { 0, 0, 0, 0x7fff, 0xa000 } // ????
...
# endif /* __STL_EXPOSE_GLOBALS_IMPLEMENTATION */
